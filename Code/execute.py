...
if TPI_solve:
    ...
    K_args = (lambdas, omega_path[0, :], imm_rates, g_n_path[0])
    ...
    if K1_cstr:
        ...
        tpi_params = (J, E, S, T1, T2, lambdas, emat, mort_rates,
                      ...
                      chi_n_vec, chi_b_vec, beta, sigma, l_tilde,
                      b_ellip, upsilon, g_y, Z, gamma, delta, r_ss,
                      BQ_ss, K_ss, L_ss, C_ss, b_ss, n_ss, TPI_maxiter,
        ...
        tpi_args = (J, E, S, T1, T2, lambdas, emat, mort_rates,
                    ...
                    L_ss, C_ss, b_ss, n_ss, TPI_maxiter, TPI_OutTol,
                    TPI_InTol, xi_TPI, bmat1)
